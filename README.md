...
2. 하나의 언어/프레임워크에 국한 되지 않는 문제 해결사 (Spring, Fast-API, Node.Js 등...)    
...
9개월간의 AI 애플리케이션 개발 학과 프로젝트를 팀장으로 이끌며, 다음 3가지 사회 문제 해결을 위한 서비스 개발 과정을 리드함        
1. (주목한 문제) 국내 전동 킥보드 사고율 증가 현상    
   -> (개발물) AI 사고 감지 & 자동 신고 APP 개발 : 28팀 중 1등, 장학금 & A+ 취득   
2. (주목한 문제) 국내 정신 질환 발병률 증가 현상     
   -> (개발물) 4가지 모드의 AI 상담사를 비롯한 AI 멘탈케어 종합 솔루션 APP 개발 : 프로젝트 성적 A+      
3. (주목한 문제) 국내 성인 독서율 지속 하락 현상      
   -> (개발물) 독자적인 Daily 독후감 솔루션 & AI를 활용한 APP 개발 : 프로젝트 성적 A+       
