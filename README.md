...
AI를 쓰지 않으면 뒤쳐지고,   
AI만 쓰면 대체되는 Agent 시대 가운데,     
스타트업에서 배운 빠르고 유연한 AI 기반의 개발 능력을 통해 조직에서 명확한 비지니스 임팩트를 내는 개발자로 성장하겠습니다. 
...
9개월간의 AI 애플리케이션 개발 학과 프로젝트를 팀장으로 이끌며,    
다음 3가지 사회 문제 해결을 위한 '기획-설계-개발-테스트/리펙토링' 과정을을 리드했습니다.  

* 🧩 주목한 문제(1) : 국내 전동 킥보드 사고율 증가 현상    
찾은 해결책 : 킥라니 구조대  
내용 : 자동 사고 탐지 AI 모델을 연동한, 자동/수동 119 신고 기능   
성과 : 28팀 중 1등, 장학금 & A+ 취득   

* 🧩 주목한 문제(2) : 국내 정신 질환 발병률 증가 현상     
찾은 해결책 : Avery  
내용 : 4가지 모드의 AI 심리 상담 챗봇, AI Diary, 1분 멘탈 종합 검진 테스트 등 멘탈케어 종합 솔루션 개발   
성과 : 프로젝트 성적 A+      

* 🧩 주목한 문제(3) : 국내 성인 독서율 지속 하락 현상       
찾은 해결책 : Book Calendar   
내용 : AI Daily 독후감, AI 도서 추천 및 커뮤니티 기능         
성과 : 프로젝트 성적 A+       
