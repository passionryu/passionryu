...
AI를 단순한 코드 생성 도구가 아니라, 반복 업무를 줄이고 문제 해결 속도를 높이는 개발 파트너로 활용합니다.       
스타트업에서 빠른 출시와 잦은 변화에 대응하며, AI 주도 개발로 3개월 만에 선불 카드 시스템 초기 모델을 출시했습니다.    

### 🧭 근거 기반으로 판단하는 개발자
AI를 활용한 개발에서 중요한 것은 더 많은 코드를 생성하는 것이 아니라, 생성된 결과가 왜 타당한지 판단하는 능력이라고 생각합니다.   
Plan First Workflow와 Human Approval Gate를 적용해 AI의 제안을 사전에 검토하고, 사람이 최종 판단하는 개발 흐름을 설계했습니다.

구현은 자동화될 수 있어도 판단은 개발자의 책임입니다.  
최신 AI 기술에 대한 지속적인 관심과 탄탄한 CS 지식을 유지하며 AI가 최적의 효율을 낼 수 있도록 관리하고 검토하는 엔지니어가 되는 것이 제 방향성입니다.

---
 ### 🧠 AI-Driven Development 
 
* 🎤 컨퍼런스 발표 : <a href="https://www.youtube.com/watch?v=Po1S4HBXo6w" target="_blank" rel="noopener noreferrer">
“AI를 쓰지 않으면 뒤처지고, AI에만 의존하면 대체된다”
</a>

* 🚀 7단계 Work-Flow와 8개 Multi-Agents System을 통제하는 Harness 연구 개인 프로젝트      
-7단계 Work-Flow : 기획 - 설계 - 개발 - 1차 AI QA - 최종 인간 개발자 E2C 테스트 및 검수 - Stage - 배포    
-일주일 만에 배포한 MVP : [**Haru Mind**][haru-mind]    
-서비스 Repository : [**하루 마인드 Repository**][my-mental-care]    
-Harness Repository : [**Multi-Agent Harness System Repository**][harness]   

[haru-mind]: https://my-mental-careweb-production.up.railway.app/
[my-mental-care]: https://github.com/passionryu/myMentalCare
[harness]: https://github.com/passionryu/Harness
...
| Area                      | Technologies                           |
| ------------------------- | -------------------------------------- |
| **Backend Development**   | Kotlin · Spring Boot · QueryDSL |
| **Data Layer**            | MariaDB · Redis                        |
| **Architecture & Design** | Hexagonal Architecture · DDD           |
