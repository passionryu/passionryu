...
스타트업에서 빠른 출시와 잦은 변화에 대응하며, AI 주도 개발로 3개월만에 선불 카드 시스템 초기 모델을 출시했습니다.    

AI가 답을 제안하는 시대, 저는 근거를 바탕으로 옳은 답을 판단하는 개발자가 되겠습니다.    
구현은 자동화될 수 있어도 판단은 책임져야 하기에, 근거 있는 의사결정으로 가치를 만드는 엔지니어가 되겠습니다.

앞으로도 기술 자체에 머무르지 않고, 제품 출시 속도와 운영 안정성, 사용자 경험에 실질적인 비즈니스 임팩트를 만드는 개발자로 성장하고자 합니다.
