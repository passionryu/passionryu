...
<img src="img.png" width="100%" alt="Biscuit Card 앱 화면: 카드 관리 · 카드 이력 · 포인트 관리 · 카드 구매 페이지">
...
| 프로젝트 | 내용 | 링크 |
|:--|:--|:--|
| **BookCalendar**<br><sub>2025.03 ~ 06 · 3차 · 백엔드 개발자 · 팀장</sub> | 🎯 **문제**<br>&emsp;10년간 독서율 72%→41% 하락, 독서를 이어가게 하는 AI Daily 독서 서비스<br>🛠️ **한 일**<br>&emsp;· 온프레미스 Linux에 Node.js·Spring·FastAPI 폴리글랏 아키텍처와 GitHub Actions CI/CD 구축<br>&emsp;· Spring 메인 서버 46개 API 구현, Redis 캐시 서버·세션 서버 분리 구축<br>&emsp;· Cache-Aside 패턴으로 핵심 API 10개 성능 개선<br>&emsp;· 공용 GPU 과부하 시 Spring AI로 GPT API 폴백, 할루시네이션은 GPT 역할 변경으로 해결<br>✅ **결과**<br>&emsp;핵심 API 10개 98.56% 개선 · A+ | [Repo](https://github.com/passionryu/BookCalendarServer)<br>[Notion](https://faint-lavender-bab.notion.site/AI-Vengers-BookCalendar-AI-1d1bc068c52d8087b61fdf9677abf2b9) |
| **Avery · AI Mental Care**<br><sub>2024.09 ~ 12 · 2차 · 백엔드 개발자 · 팀장</sub> | 🎯 **문제**<br>&emsp;정신질환 평생 유병률 27%, 생성형 AI 기반 개인 맞춤 멘탈케어<br>🛠️ **한 일**<br>&emsp;· 온프레미스 Linux에 Spring·FastAPI 폴리글랏 아키텍처와 CI/CD 구축<br>&emsp;· Spring AI Beta를 정식 출시 9개월 전에 적용해 GPT 연동<br>&emsp;· 4가지 모드 심리상담 챗봇, AI 다이어리(AI 레포트·마음 네컷), 정신질환 자가진단, 관리자 서버 구현<br>✅ **결과**<br>&emsp;자가진단 → AI 상담 → AI 감정 정리 플로우 완성 · A+ | [Repo](https://github.com/passionryu/Chat_Bot) |
| **킥라니 구조대**<br><sub>2023.09 ~ 12 · 1차 · 임베디드 개발자 · 팀장</sub> | 🎯 **문제**<br>&emsp;5년간 1382.9% 증가한 전동킥보드 사고, 골든타임 확보<br>🛠️ **한 일**<br>&emsp;· Android(Java)·Raspberry Pi·Firebase Realtime DB를 연동한 AIoT 아키텍처 구축<br>&emsp;· 리드 스위치·ADXL345 가속도 센서 모듈로 실시간 데이터 수집<br>&emsp;· AI 사고 판단 시 GPS 좌표 기반 119 자동 신고, 수동 취소 지원<br>&emsp;· 실제 킥보드에 부착해 테스트<br>✅ **결과**<br>&emsp;28팀 중 1등 · 장학금 · A+ | [Repo](https://github.com/passionryu/Automatic-Reporting-App-AIOT-project) |
...
<table>
  <tr>
    <td align="center" valign="top" width="50%">
      ...
      <sub><b>AI 개발 하네스 아키텍처</b> · 기획부터 지식 축적까지 7개 에이전트 워크플로우 · <a href="https://github.com/passionryu/Harness">Harness 레포</a></sub>
    </td>
    <td align="center" valign="top" width="50%">
...
<table>
  <tr>
    ...
    <td valign="top">
      ...
      <br><br>
      <a href="https://www.youtube.com/watch?v=Po1S4HBXo6w">발표 영상</a> · <a href="https://velog.io/@rsy991225/series/AI-%ED%99%9C%EC%9A%A9-%EA%B3%B5%EB%B6%80">AI 활용 공부 (Velog 시리즈)</a>
    </td>
  </tr>
  <tr>
    <td width="280" valign="top">
      <a href="img_4.png"><img src="img_4.png" width="280" alt="Haru Mind 모바일 화면: 메인 · 채팅 · 마음 리포트 · 마이페이지"></a>
    </td>
    <td valign="top">
      <b>🌿 Haru Mind</b> · 조언보다는 마음의 정리를 도와주는 AI 챗봇<br>
      AI 개발 하네스를 직접 구축해 보고, 그 하네스로 만든 MVP를 경량 클라우드(Railway)에 1주일 만에 출시해 본 개인 프로젝트입니다.
      <br><br>
      <kbd>Kotlin</kbd> <kbd>Spring Boot</kbd> <kbd>Next.js</kbd> <kbd>MariaDB</kbd> <kbd>Redis</kbd> <kbd>Railway</kbd>
      <br><br>
      <a href="https://github.com/passionryu/myMentalCare">Haru Mind 레포</a> · <a href="img_4.png">화면 크게 보기</a>
    </td>
  </tr>
</table>
...
| 활동 | 내용 | 링크 |
|:--|:--|:--|
| **GDG Gachon 해커톤 · 디지털 옷장**<br><sub>2025.02 · 무박 2일 · 백엔드 개발자</sub> | 🎯 **주제**<br>&emsp;일상의 사소한 불편을 해결하는 서비스<br>🛠️ **한 일**<br>&emsp;· 회원 가입·로그인 화면 구현과 서버 연동<br>&emsp;· Spring AI로 의상 추천 챗봇·리포트 구현<br>✅ **결과**<br>&emsp;장려상 (7팀 중 3등) | [Back](https://github.com/passionryu/3rdwagle-team6-back)<br>[Front](https://github.com/passionryu/3rdwagle-team6-front) |
| **Healing Space**<br><sub>2025.01 ~ 03 · 개인 프로젝트 · 풀스택 개발자</sub> | 🎯 **주제**<br>&emsp;"디지털 힐링 & 마인드 케어" 웹 서비스<br>🛠️ **한 일**<br>&emsp;· AI 다이어리 · AI 고민 상담 · AI 심리 상담 챗봇 · 힐링 커뮤니티를 React/Spring Boot로 구현<br>&emsp;· GitHub Actions → AWS 자동 배포 파이프라인 구축<br>✅ **결과**<br>&emsp;반응형 웹 서비스 배포 | [Back](https://github.com/passionryu/Healing-Space-Back)<br>[Front](https://github.com/passionryu/Healing-Space-Front)<br>[Notion](https://furtive-bard-509.notion.site/Healing-Space-Web-Service-14c83cc537b6801d92e8ec47ccfab4ab) |
...
- **Infra** · Docker · Nginx · AWS · Google Cloud · On-Premises Linux · GitHub Actions
- **Observability** · Grafana · Prometheus
- **Frontend** · TypeScript · React · Next.js
- **Architecture · Work** · Hexagonal Architecture · DDD · Claude · Codex · GitHub Kanban · Notion · Obsidian
...
| 시기 | 수상 | |
|:--|:--|:--|
| 2025.09 | 멋쟁이사자처럼 최종 프로젝트 **최우수상** | 6팀 중 1등 · DungeonTalk |
| 2025.02 | Google Developer Group Gachon 해커톤 **장려상** | 7팀 중 3등 |
