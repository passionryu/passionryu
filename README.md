...
수많은 프로젝트 경험을 통해 얻은 시각으로, "나"가 아닌 "우리"가 성공하는 길목에서     
"내가 팀을 위해 해야 할 일"을 "능동적"으로 찾는 개발자입니다.    

매 프로젝트마다, 저는 다음과 같이 고민합니다.   
"우리가 성공하기 위해, 내가 무엇을 해야 할까?"  
이 고민에 대한 결과는 다음 실적들을 통해 증명하겠습니다.     

#### 1. 제가 있던 팀은 항상 최고의 성과를 내었습니다. <br>
-> 2020. 가천 AI 페스티벌 17개 팀 中 최우수팀 수상          
-> 2023. 가천 P-project 28개 팀 中 최우수팀 수상 / 프로젝트 성적 A+ / 팀장 역임       
-> 2024. 1차 CapStone 디자인 프로젝트 성적 A+ / 팀장 역임      
-> 2025. GDG 해커톤 8개 팀 中 장려상 수상      
-> 2025. 2차 CapStone 디자인 프로젝트 성적 A+ / 팀장 역임  
-> 2025. 멋쟁이 사자처럼 실전 프로젝트 시, 팀원의 40% 중도 이탈에도 마감기한 준수 및 베타 테스팅 완료 / 팀장 역임      
-> 2025. 멋쟁이 사자처럼 종합 프로젝트 최우수상 수상 

#### 2. 저는 기록과 정리를 통해 팀원들의 이해를 돕습니다. <br>
-> 지난 1년간 280개의 Velog 개발 블로그를 작성했습니다.     
-> 팀 프로젝트 시, 팀원들의 원활한 개발을 위해 Organization의 Wiki에 제 구현 기록을 정리합니다.   
-> 팀 프로젝트 시, 팀 관리를 위해 6번 팀 노션을 직접 커스터마이징 제작한 후 배포 & 관리한 경험이 있습니다.   

#### 3. 저는 일부가 아닌 전체 프로세스를 읽는 능력이 뛰어납니다. <br>
*총 7번의 개발 프로젝트 팀장 & 개발 스터디 팀장을 맡아 일부분이 아닌 전체 프로세스를 읽는 능력이 뛰어납니다.    
-> 2023. 가천  P-project AI 앱 개발팀 팀장 (15주)   
-> 2024. 교내 IT 개발 동아리 백엔드 기초 스터디 팀장 (15주)   
-> 2024. 교내 IT 개발 동아리 인증&인가 개발팀장 (15주)   
-> 2024. 1차 Capstone 디자인 프로젝트 AI 앱 개발팀 팀장 (15주)   
-> 2024. 교내 IT 개발 동아리 백엔드 심화 스터디 팀장 (15주)   
-> 2025. 2차 Capstone 디자인 프로젝트 AI 앱 개발팀 팀장 (15주)    
-> 2025. 멋쟁이 사자처럼 실전 프로젝트 웹 개발팀 팀장 (4주)    
*이외에도 풀스택 개인 프로젝트를 통해, 기획-설계-구현-배포 모든 과정을 혼자서 경험하며 하나의 SW 프로덕트가 기획 ~ 출시되는 모든 과정을 공부했습니다. 

#### 4. 저는 많은 이들 앞에서 떨지 않고 의견을 전달하는 능력이 강합니다. <br>
...
-> 2024. 1차 Capstone 디자인 프로젝트 : 2개의 AI 모델을 관리하기 위한 Fast-API 서버 구축 & 온프레미스 서버 수동 배포        
-> 2025. 개인 웹 개발 프로젝트 : JavaScript와 React를 통한 웹 개발 & 서버 연동 후 AWS S3에 Github Actions를 통한 배포       
-> 2025. 2차 Capstone 디자인 프로젝트 : 3개의 AI 모델을 관리하기 위한 Fast-API 서버 구축 & 온프레미스 서버에 Github Actions를 통한 배포     
-> 2025. 멋쟁이 사자처럼 실전 프로젝트 : TypeScript를 통한 웹 개발 & 서버 연동 후 AWS의 Amplify를 통한 배포      

#### 6. 저는 채력과 열정이 넘치는 개발자입니다. <br>
-> 2020.12~2022.06 대한민국 해병대 제 2사단 근무 (K9 자주포 사수 / 제 1265기)   
...
| 2025.06 - 2025.08 | [멋쟁이 사자처럼] - 백엔드 단기 심화 부트캠프 | * 수료 <br> 최종 프로젝트 최우수팀 수료 <br> * 실전 프로젝트 <br> 팀장 & 풀스택 개발 및 AWS 배포 <br> * 최종 프로젝트 <br> 인증,인가 & 보안 & 자동 장애 대응 시스템 구축 담당 |
...
- **성과** :    
최우수상 수상    
POC 과정을 통한, 감이 아닌 실제 데이터로 프로젝트의 방향성을 판단     
