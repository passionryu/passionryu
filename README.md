...
### 💳 Biscuit Card 서비스 개발
<img src="img.png" alt="스타트업 근무 이력" width="760" style="max-width:100%; height:auto; border-radius:10px;" />
...
<table>
  ...
  <tr>
    ...
    <td>
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Java-007396.svg?logo=java&logoColor=white" alt="Java">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Kotlin-7F52FF.svg?logo=kotlin&logoColor=white" alt="Kotlin">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Spring_Boot-6DB33F.svg?logo=spring&logoColor=white" alt="Spring Boot">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Spring_Security-6DB33F.svg?logo=spring&logoColor=white" alt="Spring Security">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/JPA-6DB33F.svg?logoColor=white" alt="JPA">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/QueryDSL-4A90E2.svg?logoColor=white" alt="QueryDSL">
    </td>
  </tr>
  <tr>
    <td><strong>Data Layer</strong></td>
    <td>
      <img style="border-radius:10px;" src="https://img.shields.io/badge/MariaDB-003545.svg?logo=mariadb&logoColor=white" alt="MariaDB">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/MySQL-00758F.svg?logo=mysql&logoColor=white" alt="MySQL">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Valkey-DC382D.svg?logo=redis&logoColor=white" alt="Valkey">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Redis-DC382D.svg?logo=redis&logoColor=white" alt="Redis">
    </td>
  </tr>
  <tr>
    <td><strong>Architecture & Design</strong></td>
    <td>
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Hexagonal_Architecture-4E4E4E.svg" alt="Hexagonal Architecture">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Domain--Driven_Design-2A9D8F.svg" alt="DDD">
    </td>
  </tr>
  <tr>
    <td><strong>Infrastructure</strong></td>
    <td>
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Nginx-009639.svg?logo=nginx&logoColor=white" alt="Nginx">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Docker-2496ED.svg?logo=docker&logoColor=white" alt="Docker">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/AWS-232F3E.svg?logo=amazonaws&logoColor=white" alt="AWS">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Google_Cloud-4285F4.svg?logo=googlecloud&logoColor=white" alt="GCP">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/On--Premises(Linux)-4B5563.svg" alt="On-Premises">
    </td>
  </tr>
  <tr>
    <td><strong>Observability</strong></td>
    <td>
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Grafana-F46800.svg?logo=grafana&logoColor=white" alt="Grafana">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Prometheus-E6522C.svg?logo=prometheus&logoColor=white" alt="Prometheus">
    </td>
  </tr>
  <tr>
    <td><strong>ETC</strong></td>
    <td>
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Codex-333333.svg?logo=openai&logoColor=white" alt="Codex">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Notion-000000.svg?logo=notion&logoColor=white" alt="Notion">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Obsidian-7C3AED.svg?logo=obsidian&logoColor=white" alt="Obsidian">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/Discord-5865F2.svg?logo=discord&logoColor=white" alt="Discord">
      <img style="border-radius:10px;" src="https://img.shields.io/badge/GitHub_Kanban-181717.svg?logo=github&logoColor=white" alt="GitHub Kanban Board">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" valign="top" width="50%">
      <div style="border:1px solid #ccc; border-radius:10px; padding:10px; background-color:#f9f9f9;">
        <img style="border-radius:10px;" src="https://github.com/user-attachments/assets/dab4479e-2b2b-4f9a-b435-d884b006343c" width="400" alt="힐링스페이스"/><br/>
        <b>힐링스페이스</b><br/>
    ...
    <td align="center" valign="top" width="50%">
      <div style="border:1px solid #ccc; border-radius:10px; padding:10px; background-color:#f9f9f9;">
        <img style="border-radius:10px;" src="https://github.com/user-attachments/assets/d4f92419-4038-4f52-9652-f36378cbac7d" width="400" alt="북캘린더"/><br/>
        <b>북캘린더</b><br/>
  ...
  <tr>
    <td align="center" valign="top" width="50%">
      <div style="border:1px solid #ccc; border-radius:10px; padding:10px; background-color:#f9f9f9;">
        <img style="border-radius:10px;" src="https://github.com/user-attachments/assets/8be56188-2a33-40a5-8b31-cd35835189d4" width="400" alt="멋쟁이 뉴스 배달부"/><br/>
        <b>멋쟁이 뉴스 배달부</b><br/>
    ...
    <td align="center" valign="top" width="50%">
      <div style="border:1px solid #ccc; border-radius:10px; padding:10px; background-color:#f9f9f9;">
        <img style="border-radius:10px;" src="https://github.com/user-attachments/assets/0e0465c4-dca6-4af2-8c58-1d1d355f002a" width="400" alt="던전톡"/><br/>
        <b>던전톡</b><br/>
