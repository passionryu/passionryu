...
스타트업에서 빠른 출시와 잦은 변화에 대응하며, AI 기반 자동화 프로세스 구축과 백엔드 설계 역량을 함께 키워왔습니다.   

앞으로도 기술 자체에 머무르지 않고, 제품 출시 속도와 운영 안정성, 사용자 경험에 실질적인 비즈니스 임팩트를 만드는 개발자로 성장하고자 합니다.

* 컨퍼런스 발표 - <a href="https://www.youtube.com/watch?v=Po1S4HBXo6w&t=1324s" target="_blank" rel="noopener noreferrer">
