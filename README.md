...
<h3> 코딩을 통한 비지니스 임펙트를 간구하는 백엔드 개발자 류성열입니다.</h3>
...
## 🪪 About ME
안녕하세요! <br>
치열한 고민의 결과로 산출된 "비지니스 임팩트"를 통한 가치 창출에 매력을 느끼는 백엔드 개발자 류성열입니다 : )
...
#### 3. 저는 프로젝트 전체를 보는 개발자입니다! <br>
-> 총 7번의 프로젝트 팀장 & 개발 스터디 팀장을 맡아 일부분이 아닌 전체 프로세스를 읽는 능력이 뛰어납니다.      
-> 풀스택 개인 프로젝트를 통해, 기획-설계-구현-배포 모든 과정을 혼자서 경험했습니다.

#### 4. 저는 의견 전달을 잘하는 개발자입니다! <br>
...
-> 2025. 멋쟁이 사자처럼 실전 프로젝트 : 최종 결과물 PPT 발표   
-> 2025. 멋쟁이 사자처럼 종합 프로젝트 : 강사/보조강사 + 임원급 실무진들 앞에서 최종 결과물 PPT 발표 

#### 5. 저는 체력이 좋은 개발자입니다! <br>
-> 2020.12 ~ 2022.06 : 대한민국 해병대 제2 해병사단 근무 (K9 자주포 사수)
