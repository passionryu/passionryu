...
프로젝트를 진행하다가 문제가 발생할 시, 문제 해결 전략을 리더로서 책임감을 가지고 최전선에서 팀원들과 함께 고민하며 문제 해결 능력을 키워왔습니다.        
특히, 캐싱 시스템 구축(3회 경험), 서버 장애 자동 대응 시스템(2회 경험) 구축을 통한 UX 개선을 정말 좋아합니다.    
현재는 장애 대응 & 고가용성 & 고성능 & 트래픽 분산 및 Auto Scaling 기능이 보장된 서버 설계를 위한 개인 연구 프로젝트를 진행하며 실무에서 활용되는 안정적인 서버 아키텍처에 대해 공부하는 중입니다.  
