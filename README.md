...
|--------------|--------------|-------------|----------|--------------|-------|
| Gachon.Univ P_project <br> 개발 대회 | 킥라니 구조대 APP <br> - 쓰러진 킥라니를 구출하라| 팀장<br>  임배디드 개발<br>(Python, Raspberry Pi). <br > 기획  | 2023.09.01 -<br> 2023.12.21 | - 28개 팀 中 1등 | [Team Repository](https://github.com/passionryu/Automatic-Reporting-App-AIOT-project) |
